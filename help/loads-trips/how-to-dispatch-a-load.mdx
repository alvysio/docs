...
description: "Dispatch a load by assigning a driver, truck, and trailer to advance the trip to Covered status, using the standard flow or preference dialog."
---
