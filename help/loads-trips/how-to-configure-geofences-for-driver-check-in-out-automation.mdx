---
title: "Configure geofences for driver check-in/out automation"
description: "Configure per-subsidiary geofence arrival radius so the Alvys mobile app prompts drivers to check in and out automatically at each stop location."
---
