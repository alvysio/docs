...
description: "Use Dispatch Planner v2 to match unassigned trips with available drivers and assets in one live workspace, with inline edits, chat, and DAT posting."
---
