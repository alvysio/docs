...
description: "Fix the \"2 Owner Operators cannot be assigned to a trip\" error caused when a truck is already linked to a different OOP during driver assignment."
---
