...
description: "Assign sales agents, service reps, load planners, and carrier sales agents to loads and trips, or preconfigure default roles on customer profiles."
---
