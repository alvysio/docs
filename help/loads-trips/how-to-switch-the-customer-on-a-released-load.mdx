...
description: "Change the customer on a Released load by reverting it to Delivered, updating the customer, and re-releasing it using the ReleaseLoads permission."
---
