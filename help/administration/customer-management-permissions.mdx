...
description: "Control who can create, edit, activate, or delete Customer and Broker/3PL records in Alvys with the four Customer Management user permissions."
---
