...
description: "Assign the 16 Management and 4 Privacy permissions that gate user setup, carrier and asset control, webhooks, Tax ID, SSN, PII, and ACH banking access."
---
