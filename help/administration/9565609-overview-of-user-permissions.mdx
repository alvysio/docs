...
description: "Reference list of every Alvys user permission, grouped by category, with plain-language notes on what each access right, role toggle, or privilege controls."
---
