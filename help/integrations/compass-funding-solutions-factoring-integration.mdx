...
description: "Submit invoice batches from Alvys to Compass Funding Solutions via FTP, then upload purchase reports from the client portal to update load factoring status."
---
