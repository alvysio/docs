...
description: "Set up the Wex FleetOne FTP factoring integration in Alvys, add required reference numbers to loads, and submit invoice batches via FTP for AR financing."
---
