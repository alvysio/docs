...
description: "Connect a Sage Intacct entity to an Alvys subsidiary, then configure AR and AP sync, payment terms, and carrier export settings for two-way accounting."
---
