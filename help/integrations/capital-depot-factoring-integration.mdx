...
description: "Use the manual Capital Depot factoring workflow in Alvys: generate a batch invoice file, submit it to Capital Depot, then upload purchase and payment reports."
---
