...
description: "Submit invoice batches from Alvys to TAFS through the factoring API, approve them in the TAFS portal, and receive daily purchase and payment status updates."
---
