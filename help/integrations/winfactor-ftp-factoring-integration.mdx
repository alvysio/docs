...
description: "Set up the WinFactor FTP factoring integration in Alvys, submit invoice batches via FTP, and upload purchase and payment reports to update load statuses."
---
