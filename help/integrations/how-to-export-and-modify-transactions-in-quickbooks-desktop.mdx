...
description: "Export customer invoices, carrier bills, and driver settlements from Alvys to QuickBooks Desktop using the Web Connector, then modify posted transactions."
---
