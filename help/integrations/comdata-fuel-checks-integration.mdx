...
description: "Connect Comdata to Alvys to import fuel card transactions from FTP and issue e-checks to drivers for advances, lumpers, and repairs from Alvys."
---
