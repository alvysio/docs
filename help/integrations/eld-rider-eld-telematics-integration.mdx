...
description: "Connect ELD Rider to Alvys with an API key to pull truck locations, driver Hours of Service status, and fuel level data into your dispatch workflow."
---
