...
description: "Send invoice batches from Alvys to Triumph Business Capital (TBC) via FTP, then upload Triumph portal purchase and payment reports back for load reconciliation."
---
