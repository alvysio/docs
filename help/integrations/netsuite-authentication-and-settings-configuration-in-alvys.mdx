...
description: "Authenticate NetSuite in Alvys with Token-Based Authentication, then configure transaction types, subsidiaries, dimensions, and export settings before mapping."
---
