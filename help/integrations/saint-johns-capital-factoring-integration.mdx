...
description: "Connect Saint Johns Capital (SJC) to Alvys via a two-way API to submit invoice batches for factoring and run automatic broker credit checks in real time."
---
