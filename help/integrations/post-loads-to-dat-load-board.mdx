...
description: "Post brokerage loads to the DAT load board directly from Alvys, either manually from a load's detail page or automatically on a recurring auto-sync schedule."
---
