...
description: "Set up the TruFunding API factoring integration in Alvys to send invoice batches directly to TruFunding from the Factoring Upload page for same-day funding."
---
