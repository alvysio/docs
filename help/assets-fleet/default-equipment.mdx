...
description: "Pre-select a default trailer type at the subsidiary or customer level so new loads auto-fill equipment and dispatchers skip repeat data entry."
---
