---
title: "Driver List"
description: "View and filter external carrier drivers with the Employment Type column in Assets > Drivers so your fleet and partner drivers stay in one searchable list."
---
