---
title: "Import the preconfigured Alvys Public API.pbix file"
description: "Download and import the Alvys Public API.pbix file into Power BI Desktop, then update the tenant, client ID, and client secret parameters to connect."
---
