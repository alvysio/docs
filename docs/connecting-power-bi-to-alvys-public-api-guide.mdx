...
description: "Connect Power BI to the Alvys Public API using POST search endpoints for advanced filtering, dynamic queries, and reporting on loads, drivers, and more."
---
