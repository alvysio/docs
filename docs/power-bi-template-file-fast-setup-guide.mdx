...
description: "Fast-setup guide for the Alvys Public API.pbix template — load prebuilt queries, sample reports, and parameters into Power BI Desktop in minutes."
---
