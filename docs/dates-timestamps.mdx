...
description: "How the Alvys API represents dates, timezone-aware datetimes, and UTC datetimes using the RFC 3339 string format, with serialization examples for each type."
---
