...
description: "Delete a specific note attached to a load by note ID and load number, permanently removing the comment from the load timeline and operational history."
