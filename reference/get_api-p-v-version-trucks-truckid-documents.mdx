...
description: "List all documents attached to a truck by truck ID, including registration, IFTA credentials, inspection reports, and lease or title paperwork."
