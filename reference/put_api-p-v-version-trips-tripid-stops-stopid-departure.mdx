...
description: "Record the departure timestamp on a trip stop by trip and stop ID, marking when the driver left the shipper or consignee location for the next stop."
