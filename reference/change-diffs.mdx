...
description: "How load.changed and trip.changed webhook events expose changed fields via data.diff, including the optional previousAttributes payload for delta processing."
---
