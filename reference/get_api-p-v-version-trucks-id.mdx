---
title: "Get truck"
description: "Retrieve a single truck record by ID, including truck number, make and model, VIN, license plate, current driver, and last reported GPS position."
