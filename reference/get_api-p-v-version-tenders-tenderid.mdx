---
title: "Get tender"
description: "Retrieve a single tender by tender ID from Alvys, including customer, offered rate, stops, equipment requirements, and current acceptance status."
openapi: "GET /api/p/v{version}/tenders/{tenderId}"
---
