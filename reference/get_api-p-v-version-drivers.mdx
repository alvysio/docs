---
title: "List drivers"
description: "List drivers in your Alvys tenant with pagination, returning employment status, home terminal, license class, current truck assignment, and contact details."
openapi: "GET /api/p/v{version}/drivers"
---
...
![](https://files.readme.io/11c16fd-List_all_drivers.gif)
