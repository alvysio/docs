---
title: "Get driver"
description: "Retrieve a single driver record by ID from Alvys, including license details, contact info, pay setup, home terminal, and current employment status."
