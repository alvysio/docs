...
description: "List all documents on file for a driver by driver ID, including CDLs, medical cards, drug test results, hire packets, and other compliance uploads."
