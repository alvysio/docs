...
description: "Create a one-time driver deduction that applies to a single upcoming settlement, specifying the driver, amount, deduction type, and effective date."
