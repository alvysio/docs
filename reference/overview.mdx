...
description: "How Alvys webhooks deliver real-time business events over signed HTTPS POST requests, configured per Subsidiary with at-least-once delivery and retries."
---
