...
description: "Create a carrier invoice in Alvys for a completed load, including line items, accessorials, deductions, and the total amount owed to the carrier."
