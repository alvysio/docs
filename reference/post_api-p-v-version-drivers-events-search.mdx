---
title: "Search driver events"
description: "Search driver duty and location events with paginated POST filters — driver, event type, date range, and load or trip context for HOS and telematics data."
openapi: "POST /api/p/v{version}/drivers/events/search"
---
