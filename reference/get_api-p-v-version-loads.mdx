---
title: "Get load"
description: "Retrieve load records from Alvys by load number, including customer, rate, stops, assigned driver and truck, current status, and reference numbers."
