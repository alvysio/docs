---
title: "Create tender"
description: "Create a new inbound tender in Alvys from an EDI 204 or manual offer, including customer, stops, offered rate, equipment, and reference numbers."
openapi: "POST /api/p/v{version}/tenders"
---
