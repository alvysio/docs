...
description: "Search trailer telematics events with paginated POST filters — trailer, event type, date range, and load or trip context for location and status pings."
