...
description: "Search tenders with paginated POST filters — customer, status, offered rate range, pickup and delivery windows, origin and destination, and equipment type."
