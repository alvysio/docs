...
description: "API reference for OAuth 2.0 Client Credentials authentication on the Alvys Public API — token endpoints, client app setup, and available scopes."
---
