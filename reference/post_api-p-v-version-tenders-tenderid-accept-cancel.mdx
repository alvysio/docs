---
title: "Accept tender cancellation"
description: "Acknowledge and accept a customer-initiated tender cancellation by tender ID, confirming the shipment will be released and no longer executed."
openapi: "POST /api/p/v{version}/tenders/{tenderId}/accept-cancel"
---
