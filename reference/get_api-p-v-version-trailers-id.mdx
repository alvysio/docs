---
title: "Get trailer"
description: "Retrieve a single trailer record by ID, including trailer number, type, ownership, license plate, current location, and current load or trip assignment."
openapi: "GET /api/p/v{version}/trailers/{id}"
---
...
![](https://files.readme.io/dcc8560-List_all_Trailers.gif)
