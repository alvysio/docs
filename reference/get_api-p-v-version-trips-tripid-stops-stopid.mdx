---
title: "Get trip stop"
description: "Retrieve a single trip stop by trip and stop ID, including the location, appointment window, arrival and departure timestamps, and stop-level notes."
openapi: "GET /api/p/v{version}/trips/{tripId}/stops/{stopId}"
---
