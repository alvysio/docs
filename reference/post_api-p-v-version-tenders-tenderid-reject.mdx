---
title: "Reject tender"
description: "Reject an inbound tender by tender ID with a reason code, sending an EDI 990-style decline back to the customer so they can retender the shipment."
