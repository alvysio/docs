---
title: "Search truck events"
description: "Search truck telematics events with paginated POST filters — truck, event type, date range, and load or trip context for location, HOS, and status pings."
openapi: "POST /api/p/v{version}/trucks/events/search"
---
